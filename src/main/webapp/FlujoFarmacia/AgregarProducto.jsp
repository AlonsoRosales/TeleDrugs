			...
			<div class="container px-4 px-lg-5">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
						<li class="nav-item"><a class="nav-link" href="AgregarProducto.jsp">Agregar Producto</a></li>
						<li class="nav-item"><a class="nav-link" href="RegistroProductos.jsp">Lista de Productos</a></li>
						<li class="nav-item"><a class="nav-link" href="HistorialPedidos.jsp">Historial de pedidos</a></li>
					</ul>
					<div class="dropdown">
		...
		<section class="py-5">
			<div class="container px-4 px-lg-5 my-5"  style="margin-bottom:5px;">
				<div class="row gx-4 gx-lg-5 align-items-center">
					...
					<form method="POST" action="<%= request.getContextPath() %>/FlujoFarmacia?action=crear">
				...
				<a style="margin-top:20px; width:200px; float:right; "  class="btn btn-secondary"  href="/trabajo_war_exploded/HistorialPedido?ruc=<%=farmacia.getRuc()%>" style="width:250px;">Regresar</a>
			</div>
		</section>
